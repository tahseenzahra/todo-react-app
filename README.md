# todo-react-app
It is single page application for making to do list, it's designed with react.
...
Feel free to check the [issues page](https://github.com/tahseenzahra/todo-react-app/issues).
